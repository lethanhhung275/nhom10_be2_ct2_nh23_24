                        ...
                        <div class="col-lg-3 col-md-8 col-12">
                            ...
                            <div class="sidebar_widget banner mb-35">
                                <div class="banner_img mb-35">
                                    <a href="#"><img src="user\assets\img\banner\banner5.jpg" alt=""></a>
                                </div>
                                <div class="banner_img">
                                    <a href="#"><img src="user\assets\img\banner\banner6.jpg" alt=""></a>
                                </div>
                            </div>
                            <!--sidebar banner end-->
                            ...
                            <div class="sidebar_widget catrgorie mb-35">
                                ...
                                <ul>
                                            ...
                                            <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a>
                                                <ul class="categorie_sub">
                                                    <li><a href="#"><i class="fa fa-caret-right"></i>
                                                            Accessories</a></li>
                                                    <li><a href="#"><i class="fa fa-caret-right"></i> Dresses</a>
                                                    </li>
                                                    <li><a href="#"><i class="fa fa-caret-right"></i> Tops</a>
                                                    </li>
                                                    <li><a href="#"><i class="fa fa-caret-right"></i> HandBags</a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <li class="has-sub"><a href="#"><i class="fa fa-caret-right"></i>
                                            Jewelry</a>
                                        <ul class="categorie_sub">
                                            <li><a href="#"><i class="fa fa-caret-right"></i> Accessories</a>
                                                <ul class="categorie_sub">
                            ...
                            <div class="sidebar_widget bottom ">
                                <div class="banner_img">
                                    <a href="#"><img src="user\assets\img\banner\banner9.jpg"
                                            alt=""></a>
                                </div>
                            </div>
                            <!--sidebar banner end-->
                            ...
                            <div class="banner_slider slider_1">
                                <div class="slider_active owl-carousel">
                                    <div class="single_slider"
                                        style="background-image: url(user/assets/img/slider/slide_1.png)">
                                    ...
                                    <div class="single_slider"
                                        style="background-image: url(user/assets/img/slider/slider_2.png)">
                                        <div class="slider_content">
                                            <div class="slider_content_inner">
                                    ...
                                    <div class="single_slider"
                                        style="background-image: url(user/assets/img/slider/slider_3.png)">
                                        <div class="slider_content">
                                            <div class="slider_content_inner">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Curabitur
                                                            sodales</a></h3>
                                                </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Quisque
                                                            ornare dui</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Sed non
                                                            turpiss</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                    ...
                                    <div class="product_active owl-carousel">
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    <span class="product_price">$60.00</span>
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Maecenas
                                                            sit amet</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    ...
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Donec ac
                                                            congue</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                ...
                                                <div class="product_content">
                                                    <span class="product_price">$50.00</span>
                                                    <h3 class="product_title"><a href="{{ url('single-product') }}">Phasellus
                                                            a arcu</a></h3>
                                                </div>
                                                <div class="product_info">
                                                    <ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="single_banner">
                                            <a href="#"><img src="user\assets\img\banner\banner7.jpg"
                                                    alt=""></a>
